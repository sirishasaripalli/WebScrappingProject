...
public class Beverages extends hooksForScrapping {
...
//						// example: recipeIdUrls.put("id","url");
					...
					for (Map.Entry<String, String> recipeIdUrlEntry : recipeIdUrls.entrySet()) {
						...
						tlDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
						 ...
						 if (containsSugar()) {
		                        ...
		                        try {
		                            writeOutput.setCellData("Beverages", rowCounter, 0, recipeId);
		                        } catch (Exception e) {
		                        }
                        // Recipe Name
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 1, recipeTitle.getText());
                        } catch (Exception e) {
                        }
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 2, recipeCategory.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 3, foodCategory.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 4, nameOfIngredients.getText());
                        } catch (Exception e) {
                        }
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 5, preparationTime.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 6, cookTime.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 7, tagsTags.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 8, numberOfServings.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 9, cusineCategory.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 10, recipeDescription.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 11, prepMethod.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 12, nutrients.getText());
                        ...
                        try {
                            ...
                            writeOutput.setCellData("Beverages", rowCounter, 13, recipeUrl);
                        } catch (Exception e) {
			...
			writeToDatabase.insertData(1, "scrapping");
        }
    }
